        ...
        >
          <div class="con-tab-ejemplo">
            <div class="row">
              ...
              <div v-if="showAddNewCategory1" class="col-12 edit1 mb-3">
                <div class="con-upload">
                  <div class="con-img-upload">
                    ...
                    >
                      <input type="file" ref="fileInputCategory1" v-on:change="onFileChangeCat1" />
                    ...
                    <div class="img-upload" v-if="Category.category1.image">
                      <button type="button" @click="clear_fileCat1()" class="btn-x-file">
                      ...
                      <img :src="Category.category1.image" width="100%" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-12 mb-3">
                <div style="animation:open 0.3s;" class="custom_input">
                  <label for class="vs-input--label" style="display:block;">Main Category*</label>
                  <el-select
              ...
              <div v-if="showAddNewCategory1" class="col-lg-12 mb-3">
                <vs-input
                  class="edit2_btns"
                  label="Icon*"
                  placeholder="eg-user"
              ...
              <div v-if="showAddNewCategory1" class="col-lg-12 mb-3">
                <vs-textarea label="Description" v-model="Category.category1.description" />
              </div>
            </div>
          </div>
        </tab-content>
        ...
        >
          <div class="con-tab-ejemplo">
            <div class="row">
              ...
              <div v-if="showAddNewCategory2" class="col-12 edit1 mb-3">
                <div class="con-upload">
                  <div class="con-img-upload">
                    <div
                      class="con-input-upload"
                      ...
                      style="margin: 5px !important;"
                    >
                      <input type="file" ref="fileInputCategory2" v-on:change="onFileChangeCat2" />
                      <span class="text-input">Upload File</span>
                      <button
                        type="button"
                        @click="triggerCat2()"
                    ...
                    <div class="img-upload" v-if="Category.category2.image">
                      <button type="button" @click="clear_fileCat2()" class="btn-x-file">
                        <i translate="translate" class="material-icons notranslate">clear</i>
                      </button>
                      <button
                        class="btn-upload-file on-progress ready-progress"
                      ...
                      <img :src="Category.category2.image" width="100%" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div v-if="showAddNewCategory2" class="col-lg-12 mb-3">
                <vs-input
                  class="edit2_btns"
                  label="Icon*"
                  placeholder="eg-user"
              ...
              <div v-if="showAddNewCategory2" class="col-lg-12 mb-3">
                <vs-textarea label="Description" v-model="Category.category2.description" />
              </div>
            </div>
          </div>
        </tab-content>

        <tab-content title="Category" :before-change="validateThirdStep" icon="feather icon-user">
          <div class="con-tab-ejemplo">
            <div class="row">
              <vs-alert
                title="Validate Error!"
...
export default {
  ...
  methods: {
    ...
    validateThirdStep() {
      if (!this.Category.image || !this.Category.label || !this.Category.icon) {

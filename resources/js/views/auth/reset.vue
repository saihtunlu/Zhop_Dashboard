  ...
  <div class="login_Page">
    <div class="row login_row">
      <div class="col-lg-6 sign_img_div">
        ...
        >
          ...
          <path
            ...
            fill="#6c63ff"
          />
          <ellipse cx="985.23" cy="791.38" rx="29.92" ry="5.06" fill="#6c63ff" opacity="0.1" />
          <path
            ...
            fill="#6c63ff"
          />
          <ellipse cx="1079.04" cy="697.06" rx="16.87" ry="2.85" fill="#6c63ff" opacity="0.1" />
          <path
            ...
            fill="#6c63ff"
          />
          <ellipse cx="934.94" cy="715.91" rx="20.37" ry="3.44" fill="#6c63ff" opacity="0.1" />
          <path
          ...
          <path
            ...
            fill="#ffd037"
          />
          <ellipse cx="157.52" cy="740.06" rx="62.19" ry="9.54" fill="#6c63ff" opacity="0.1" />
          <path
      ...
      <div class="col-lg-6 sign_content">
        ...
        <vs-alert
          color="danger"
          :active.sync="reset_error"
          closable
          close-icon="close"
        >{{ error_message }}</vs-alert>
        <form @submit.prevent="reset" class="sign_form">
          <vs-input
            class="sign_input"
            type="email"
            icon-pack="feather"
          ...
          <vs-input
            ...
            danger-text="Password confrimation is not the same with password!"
            class="sign_input"
            type="password"
            icon-pack="feather"
            icon="icon-lock"
            ...
            label-placeholder="Password Comfirmation"
            v-model="user.password_confirmation"
          />
          <div class="sign_btns">
            <vs-button color="primary" class="forgot_btn" to="/signIn" type="border">Back to SignIn</vs-button>
            <button
              ref="loadableButton"
              type="submit"
              name="button"
            ...
            >
              <span class="vs-button-text vs-button--text">Reset</span>
            </button>
          </div>
        </form>
      </div>
...
export default {
  ...
  mounted() {
    ...
    this.get_more_information(token);
  },
  methods: {
    get_more_information(token) {
      axios
        .post(`/password/find`, { token: token })
        .then(response => {

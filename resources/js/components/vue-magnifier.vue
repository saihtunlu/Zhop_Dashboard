    ...
    <div class="vue-magnifier-container">
      ...
      >
        <span
          ...
          v-bind:style="{backgroundImage: 'url(' + srcLarge + ')', backgroundPosition: backgroundPos, left: cursorX + 'px', top: cursorY + 'px'}"
        ></span>
      </span>
    </div>
  </div>
...
$sizes: (
  "(max-width: 320px)" 100% 250px,
  "(max-width: 480px)" 100% 350px,
  "(min-width: 481px)" 100% 450px,
  "(min-width: 1024px)" 100% 550px,
  "(min-width: 1280px)" 100% 600px
);
